...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/alymartinelli                                            | 
| 1    | Github Profile Page                         | https://github.com/alymartinelli/alymartinelli                                |
| 1    | Commit and Push Change from Command Line    | https://github.com/alymartinelli/ppchem/commit/74a0863                         |
| 1    | Create a New Branch                         | https://github.com/alymartinelli/ppchem/tree/newbranche                        |
| 1    | Create a conda environment                  | https://github.com/alymartinelli/ppchem/blob/main/env.yml                      |
| 1    | Fork a Repo                                 | https://github.com/alymartinelli/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/`alymartinelli`/practical-programming-in-chemistry-milestones/pull/`pull/1/commits` |
